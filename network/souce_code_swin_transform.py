...
[docs]class Swin_T_Weights(WeightsEnum):
...
[docs]class Swin_S_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
...
[docs]class Swin_B_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
...
[docs]class Swin_V2_T_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
...
[docs]class Swin_V2_S_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
...
[docs]class Swin_V2_B_Weights(WeightsEnum):
    IMAGENET1K_V1 = Weights(
