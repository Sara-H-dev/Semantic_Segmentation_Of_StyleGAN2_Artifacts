...
class CSV_Handler:
    def __init__(self, log_save_path):
        ...
        csv_all_epoch.writerow(["epoch","mean_accuracy","mean_val_loss", "mean_train_loss","mean_confusion_matrix_bin", "mean_confusion_matrix_soft", "Score"])
        ...
        csv_real_epoch.writerow(["epoch","accuracy_real","mean_confusion_matrix_bin", "mean_confusion_matrix_soft","mean_val_loss_real", "FRP"])
